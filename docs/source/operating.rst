[tml-multi-agenticai-iot-3f10-ml] Operating Details
====================================

Generated On: 2026-03-05 01:36:00 UTC
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-ml] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-ml] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   http://localhost:49689/iot-failure-machinelearning-agenticai.html?topic=all-agents-responses,iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=100&topictype=prediction&append=0&secure=1
...
.. important::
   maadsdocker/tml-multi-agenticai-iot-3f10-ml-amd64 (https://hub.docker.com/r/maadsdocker/tml-multi-agenticai-iot-3f10-ml-amd64)
...
.. code-block::
   ...
   docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=tml-multi-agenticai-iot-3f10-ml \
          --env SOLUTIONDAG=solution_preprocessing_ml_dag-tml-multi-agenticai-iot-3f10 \
          ...
          maadsdocker/tml-multi-agenticai-iot-3f10-ml-amd64
...
[tml-multi-agenticai-iot-3f10-ml] Github Repo
---------------
...
.. important::
   https://tml-multi-agenticai-iot-3f10-ml.readthedocs.io
...
.. important::
   solution_preprocessing_ml_dag-tml-multi-agenticai-iot-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=40327, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45785, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40089, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43523, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=42355, HPDEHOST=127.0.1.1, HPDEPORT=43417, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40397

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9945-tml-multi-agenticai-iot-3f10-ml,solution_preprocessing_ml_dag-tml-multi-agenticai-iot-3f10, python-preprocess-3566-tml-multi-agenticai-iot-3f10-ml,solution_preprocessing_ml_dag-tml-multi-agenticai-iot-3f10, python-ml-2145-tml-multi-agenticai-iot-3f10-ml,solution_preprocessing_ml_dag-tml-multi-agenticai-iot-3f10, python-predict-9258-tml-multi-agenticai-iot-3f10-ml,solution_preprocessing_ml_dag-tml-multi-agenticai-iot-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
