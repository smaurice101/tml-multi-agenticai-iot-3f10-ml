Scaling [tml-multi-agenticai-iot-3f10-ml] With Kubernetes
===========================
...
Based on your TML solution [tml-multi-agenticai-iot-3f10-ml] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`tml-multi-agenticai-iot-3f10-ml.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-tml-multi-agenticai-iot-3f10-ml.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresstml-multi-agenticai-iot-3f10-ml.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f tml-multi-agenticai-iot-3f10-ml.yml

tml-multi-agenticai-iot-3f10-ml.yml
------------------------

.. important::
   Copy and Paste this YAML file: tml-multi-agenticai-iot-3f10-ml.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/ymls/tml-multi-agenticai-iot-3f10-ml
...
.. code-block:: YAML
   ...
   ################# tml-multi-agenticai-iot-3f10-ml.yml
     ...
     kind: Deployment
     metadata:
       name: tml-multi-agenticai-iot-3f10-ml
     spec:
       selector:
         matchLabels:
           app: tml-multi-agenticai-iot-3f10-ml
       ...
       template:
         ...
         spec:
           containers:
           - name: tml-multi-agenticai-iot-3f10-ml
             image: maadsdocker/tml-multi-agenticai-iot-3f10-ml-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'tml-multi-agenticai-iot-3f10-ml'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ml_dag-tml-multi-agenticai-iot-3f10'
             - name: GITUSERNAME
               value: 'smaurice101'
             - name: GITREPOURL
   ...
   ---
     ...
     metadata:
       ...
       labels:
         app: tml-multi-agenticai-iot-3f10-ml-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/tml-multi-agenticai-iot-3f10-ml 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-tml-multi-agenticai-iot-3f10-ml.yml to your kubernetes cluster.  First you need to save it locally then apply it:**
...
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-tml-multi-agenticai-iot-3f10-ml.yml
